                        ...
                        <div className='col-lg-4 col-sm-12'>
                            ...
                            <form className="d-flex flex-row">
                                <div className="col-auto w-75">
                                    <input type="email" className="form-control" placeholder="Your email address" value={getEmail} onChange={(event) => setGetEmail(event.target.value)} />
                                </div>
                                <div className="col-auto">
                                    <button type="submit" className="btn btn-primary mb-3" onClick={checkEmailSub}>Submit</button>
                                </div>
                            </form>
